...
public class CatDolometroException extends GenericException {
   ...
   public CatDolometroException(Exception ex, String message, String layer, String action){
      super(ex,message);
      this.layer = layer;
      this.action = action;
   }

   public CatDolometroException(String message, String layer, String action){
      super(message);
      this.layer = layer;
      this.action = action;
   }
