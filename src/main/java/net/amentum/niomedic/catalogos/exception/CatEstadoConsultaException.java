...
public class CatEstadoConsultaException extends GenericException {
   ...
   public CatEstadoConsultaException(Exception ex, String message, String layer, String action){
      super(ex,message);
      this.layer = layer;
      this.action = action;
   }

   public CatEstadoConsultaException(String message, String layer, String action){
      super(message);
      this.layer = layer;
      this.action = action;
   }
