...
public class CatProgramaException extends GenericException{
    ...
    public CatProgramaException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public CatProgramaException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
