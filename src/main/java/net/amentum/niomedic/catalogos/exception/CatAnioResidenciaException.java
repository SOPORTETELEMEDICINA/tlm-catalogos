...
public class CatAnioResidenciaException extends GenericException{
    ...
    public CatAnioResidenciaException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public CatAnioResidenciaException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
