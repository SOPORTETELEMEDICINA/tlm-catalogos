...
public class CatTipoInsumoMedException extends GenericException {
   ...
   public CatTipoInsumoMedException(Exception ex, String message, String layer, String action){
      super(ex,message);
      this.layer = layer;
      this.action = action;
   }

   public CatTipoInsumoMedException(String message, String layer, String action){
      super(message);
      this.layer = layer;
      this.action = action;
   }
