...
public class CatTipoDificultadException extends GenericException{
    ...
    public CatTipoDificultadException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public CatTipoDificultadException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
