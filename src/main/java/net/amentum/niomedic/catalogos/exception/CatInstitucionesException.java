...
public class CatInstitucionesException extends GenericException {
    ...
    public CatInstitucionesException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public CatInstitucionesException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
