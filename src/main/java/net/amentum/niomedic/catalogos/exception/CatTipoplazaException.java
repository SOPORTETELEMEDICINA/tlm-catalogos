...
public class CatTipoplazaException extends GenericException {
    ...
    public CatTipoplazaException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public CatTipoplazaException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
