...
public class CatAppConfigurationException extends GenericException {
    ...
    public CatAppConfigurationException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }
    ...
    public CatAppConfigurationException(String message,String layer,String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
