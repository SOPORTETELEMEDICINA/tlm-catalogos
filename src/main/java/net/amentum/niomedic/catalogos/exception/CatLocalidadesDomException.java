...
public class CatLocalidadesDomException extends GenericException {
   ...
   public CatLocalidadesDomException(Exception ex, String message, String layer, String action){
      super(ex,message);
      this.layer = layer;
      this.action = action;
   }

   public CatLocalidadesDomException(String message, String layer, String action){
      super(message);
      this.layer = layer;
      this.action = action;
   }
