...
public class CatTitulosCie10Exception extends GenericException {
   ...
   public CatTitulosCie10Exception(Exception ex, String message, String layer, String action){
      super(ex,message);
      this.layer = layer;
      this.action = action;
   }

   public CatTitulosCie10Exception(String message, String layer, String action){
      super(message);
      this.layer = layer;
      this.action = action;
   }
