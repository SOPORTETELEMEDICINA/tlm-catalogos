...
public class CatPesoParaTallaPSPException extends GenericException{
    ...
    public CatPesoParaTallaPSPException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public CatPesoParaTallaPSPException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
