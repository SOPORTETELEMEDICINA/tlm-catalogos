...
public class CatResultadoEdiPSPException extends GenericException{
    ...
    public CatResultadoEdiPSPException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public CatResultadoEdiPSPException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
