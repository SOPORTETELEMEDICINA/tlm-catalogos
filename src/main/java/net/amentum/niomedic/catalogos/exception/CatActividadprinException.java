...
public class CatActividadprinException extends GenericException {
    ...
    public CatActividadprinException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public CatActividadprinException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
