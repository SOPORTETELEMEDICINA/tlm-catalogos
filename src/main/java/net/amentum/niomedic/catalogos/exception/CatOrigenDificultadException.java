...
public class CatOrigenDificultadException extends GenericException{
    ...
    public CatOrigenDificultadException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public CatOrigenDificultadException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
