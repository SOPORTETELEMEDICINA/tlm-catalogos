...
public class CatCuadroIoMedException extends GenericException {
   ...
   public CatCuadroIoMedException(Exception ex, String message, String layer, String action){
      super(ex,message);
      this.layer = layer;
      this.action = action;
   }

   public CatCuadroIoMedException(String message, String layer, String action){
      super(message);
      this.layer = layer;
      this.action = action;
   }
