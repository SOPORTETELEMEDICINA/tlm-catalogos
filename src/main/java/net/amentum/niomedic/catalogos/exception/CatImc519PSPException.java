...
public class CatImc519PSPException extends GenericException{
    ...
    public CatImc519PSPException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public CatImc519PSPException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
