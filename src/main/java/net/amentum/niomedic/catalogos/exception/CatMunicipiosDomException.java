...
public class CatMunicipiosDomException extends GenericException {
   ...
   public CatMunicipiosDomException(Exception ex, String message, String layer, String action){
      super(ex,message);
      this.layer = layer;
      this.action = action;
   }

   public CatMunicipiosDomException(String message, String layer, String action){
      super(message);
      this.layer = layer;
      this.action = action;
   }
