...
public class CatGpoTerapeuticoMedException extends GenericException {
   ...
   public CatGpoTerapeuticoMedException(Exception ex, String message, String layer, String action){
      super(ex,message);
      this.layer = layer;
      this.action = action;
   }

   public CatGpoTerapeuticoMedException(String message, String layer, String action){
      super(message);
      this.layer = layer;
      this.action = action;
   }
