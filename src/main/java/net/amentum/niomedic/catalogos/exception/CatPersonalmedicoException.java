...
public class CatPersonalmedicoException extends GenericException {
    ...
    public CatPersonalmedicoException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public CatPersonalmedicoException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
