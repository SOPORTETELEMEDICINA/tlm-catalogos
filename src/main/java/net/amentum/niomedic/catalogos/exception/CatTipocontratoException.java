...
public class CatTipocontratoException extends GenericException {
    ...
    public CatTipocontratoException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public CatTipocontratoException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
