...
public class CatNumerosEmergenciaException extends GenericException {
   ...
   public CatNumerosEmergenciaException(Exception ex, String message, String layer, String action){
      super(ex,message);
      this.layer = layer;
      this.action = action;
   }

   public CatNumerosEmergenciaException(String message, String layer, String action){
      super(message);
      this.layer = layer;
      this.action = action;
   }
