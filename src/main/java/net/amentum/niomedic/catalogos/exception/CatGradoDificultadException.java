...
public class CatGradoDificultadException extends GenericException{
    ...
    public CatGradoDificultadException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public CatGradoDificultadException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
