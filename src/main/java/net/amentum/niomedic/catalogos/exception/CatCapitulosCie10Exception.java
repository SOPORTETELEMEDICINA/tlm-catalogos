...
public class CatCapitulosCie10Exception extends GenericException {
   ...
   public CatCapitulosCie10Exception(Exception ex, String message, String layer, String action){
      super(ex,message);
      this.layer = layer;
      this.action = action;
   }

   public CatCapitulosCie10Exception(String message, String layer, String action){
      super(message);
      this.layer = layer;
      this.action = action;
   }
