...
public class CatReligionTest {
   ...
   @Test
   public void getDetailsByIdCatReligion() throws Exception {
      String idCatReligion = "9";
      mockMvc.perform(MockMvcRequestBuilders.get("/catalogo-religion/" + idCatReligion))
   ...
   @Test
   public void getCatReligionSearch() throws Exception {
      mockMvc.perform(MockMvcRequestBuilders.get("/catalogo-religion/search?datosBusqueda=&page=&size=&orderColumn=&orderType=")
