...
public class CatAnioResidenciaTest {
    ...
    @Test
    public void getDetailsByidAnio() throws Exception {
        Integer idAnioResidencia = 9;
        mockMvc.perform(MockMvcRequestBuilders.get("/catalogo-anio-Residencia/2"))
    ...
    public void findAll() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/catalogo-anio-Residencia/findAll"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print());
    }
    ...
    public void getCatAnioResidenciaSearch() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/catalogo-anio-Residencia/search")
